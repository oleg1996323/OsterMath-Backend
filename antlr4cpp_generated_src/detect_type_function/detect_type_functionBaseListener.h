...
public:
  ...
  virtual void enterValue_type(detect_type_function::Value_typeContext * /*ctx*/) override { }
  virtual void exitValue_type(detect_type_function::Value_typeContext * /*ctx*/) override { }
