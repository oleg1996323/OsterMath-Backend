...
struct Bound_coefsLexerStaticData final {
  Bound_coefsLexerStaticData(std::vector<std::string> ruleNames,
  ...
  Bound_coefsLexerStaticData(const Bound_coefsLexerStaticData&) = delete;
  Bound_coefsLexerStaticData(Bound_coefsLexerStaticData&&) = delete;
  Bound_coefsLexerStaticData& operator=(const Bound_coefsLexerStaticData&) = delete;
  Bound_coefsLexerStaticData& operator=(Bound_coefsLexerStaticData&&) = delete;
...
::antlr4::internal::OnceFlag bound_coefslexerLexerOnceFlag;
#if ANTLR4_USE_THREAD_LOCAL_CACHE
static thread_local
#endif
Bound_coefsLexerStaticData *bound_coefslexerLexerStaticData = nullptr;

void bound_coefslexerLexerInitialize() {
#if ANTLR4_USE_THREAD_LOCAL_CACHE
  if (bound_coefslexerLexerStaticData != nullptr) {
    return;
  }
#else
  assert(bound_coefslexerLexerStaticData == nullptr);
#endif
  auto staticData = std::make_unique<Bound_coefsLexerStaticData>(
  ...
  bound_coefslexerLexerStaticData = staticData.release();
}

}

bound_coefsLexer::bound_coefsLexer(CharStream *input) : Lexer(input) {
  bound_coefsLexer::initialize();
  _interpreter = new atn::LexerATNSimulator(this, *bound_coefslexerLexerStaticData->atn, bound_coefslexerLexerStaticData->decisionToDFA, bound_coefslexerLexerStaticData->sharedContextCache);
}

bound_coefsLexer::~bound_coefsLexer() {
  delete _interpreter;
}

std::string bound_coefsLexer::getGrammarFileName() const {
  return "bound_coefs.g4";
}

const std::vector<std::string>& bound_coefsLexer::getRuleNames() const {
  return bound_coefslexerLexerStaticData->ruleNames;
}

const std::vector<std::string>& bound_coefsLexer::getChannelNames() const {
  return bound_coefslexerLexerStaticData->channelNames;
}

const std::vector<std::string>& bound_coefsLexer::getModeNames() const {
  return bound_coefslexerLexerStaticData->modeNames;
}

const dfa::Vocabulary& bound_coefsLexer::getVocabulary() const {
  return bound_coefslexerLexerStaticData->vocabulary;
}

antlr4::atn::SerializedATNView bound_coefsLexer::getSerializedATN() const {
  return bound_coefslexerLexerStaticData->serializedATN;
}

const atn::ATN& bound_coefsLexer::getATN() const {
  return *bound_coefslexerLexerStaticData->atn;
}




void bound_coefsLexer::initialize() {
#if ANTLR4_USE_THREAD_LOCAL_CACHE
  bound_coefslexerLexerInitialize();
#else
  ::antlr4::internal::call_once(bound_coefslexerLexerOnceFlag, bound_coefslexerLexerInitialize);
#endif
}
