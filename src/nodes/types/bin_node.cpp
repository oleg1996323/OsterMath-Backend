...
Result BinaryNode::execute_for_array_variables(const std::vector<size_t>& ids,
    ...
    {
        case BINARY_OP::ADD:
            return child(0)->execute_for_array_variables(ids,structure)+
                child(1)->execute_for_array_variables(ids,structure);
            break;
        case BINARY_OP::SUB:
            return child(0)->execute_for_array_variables(ids,structure)-
                child(1)->execute_for_array_variables(ids,structure);
